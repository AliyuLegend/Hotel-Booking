...
<div class="hero-wrap js-fullheight" style="margin-top: -25px; background-image: url('{{ asset("assets/images/image_2.jpg") }}' );" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 wrap-about">
						...
						<div class="img img-2 mb-4" style="background-image: url('{{ asset("assets/images/room-2.jpg") }}' );">
						</div>
		...
		<section class="ftco-intro" style="background-image: url('{{ asset("assets/images/room_2.jpg") }}' );" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row justify-content-center">
